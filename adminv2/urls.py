...
from .views import HomeView,ProductsView,EditcategoryView,EditproductsView,CategoryView,AddcategoryView,AddproductsView,AdminloginView,DeleteProductView,UserProfileView,UserOverView,AdminSettingView
