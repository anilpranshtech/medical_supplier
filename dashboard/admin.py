...
admin.site.register(Regioncities)
admin.site.register(Unit)
admin.site.register(DeliveryTime)
admin.site.register(APIControls)
admin.site.register(Catalog)
admin.site.register(SMSConfiguration)
admin.site.register(Configuration)
admin.site.register(ReturnTime)
...
admin.site.register(DynamicInput)
admin.site.register(FormControl)
admin.site.register(SplashScreen)
admin.site.register(ShippingMethod)
admin.site.register(Coupon)
admin.site.register(BuyXGetYPromotion)
admin.site.register(BuyXGiftYPromotion)
admin.site.register(BasketPromotion)
