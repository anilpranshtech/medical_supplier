from dashboard.models import UserLogs
...
def user_log_activity(user, description, actions):
    ...
    Args:
        ...
        actions: Action type from UserLogs.ActionType choices
    """
    try:
...
def user_purchase_activity(user, description, amount):
    ...
    try:
        UserLogs.objects.create(
            user=user,
            actions=UserLogs.ActionType.PURCHASE,
            description=description,
            amount=amount
        )
    except Exception as e:
...
def user_refund_activity(user, description, amount):
    ...
    try:
        UserLogs.objects.create(
            user=user,
            actions=UserLogs.ActionType.REFUND,
            description=description,
            amount=amount
        )
    except Exception as e:
...
def user_login_activity(user):
    ...
    try:
        UserLogs.objects.create(
            user=user,
            actions=UserLogs.ActionType.LOGGEDIN,
...
def user_logout_activity(user):
    ...
    try:
        UserLogs.objects.create(
            user=user,
            actions=UserLogs.ActionType.LOGGEDOUT,
...
def user_password_change_activity(user):
    ...
    try:
        UserLogs.objects.create(
            user=user,
            actions=UserLogs.ActionType.PASSWORDCHANGE,
...
def user_subscription_cancel_activity(user, description):
    ...
    try:
        UserLogs.objects.create(
            user=user,
            actions=UserLogs.ActionType.CANCELED,
            description=description
        )
    except Exception as e:
...
def user_failed_activity(user, description):
    ...
    try:
        UserLogs.objects.create(
            user=user,
            actions=UserLogs.ActionType.FAILED,
            description=description
        )
    except Exception as e:
...
def user_update_activity(user, description):
    ...
    try:
        UserLogs.objects.create(
            user=user,
            actions=UserLogs.ActionType.UPDATED,
            description=description
        )
    except Exception as e:
...
def user_created_activity(user, description):
    """
    ...
    try:
        UserLogs.objects.create(
            user=user,
            actions=UserLogs.ActionType.CREATED,
            description=description
        )
    except Exception as e:
        print(f"Error in user_created_activity: {e}")


def user_deleted_activity(user, description):
    """
    ...
    try:
        UserLogs.objects.create(
            user=user,
            actions=UserLogs.ActionType.DELETED,
            description=description
        )
    except Exception as e:
        print(f"Error in user_deleted_activity: {e}")